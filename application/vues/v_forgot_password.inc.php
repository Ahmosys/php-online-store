...
<div class="container h-auto">
    <div class="row h-auto justify-content-center align-items-center">
        <div class="card w-75" style="margin-top: 120px; margin-bottom: 120px;">
            ...
            <div class="card-body">
                <form role="form" method="POST" action="index.php?controller=Identification&action=forgotPassword">
                    <?php
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" name="forgot_email" value="" title="" required="" placeholder="Your e-mail here">
                                </div>
                            </div>
                        </div>
                    </div>

...
<div class="container h-auto">
    <div class="row h-auto justify-content-center align-items-center">
        <div class="card w-75" style="margin-top: 120px; margin-bottom: 120px;">
            <h4 class="card-header">OTP Code</h4>
            <div class="card-body">
                <form role="form" method="POST" action="index.php?controller=Identification&action=checkOtpCode">
                    <?php
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>OTP Code | Check your e-mail</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-user" aria-hidden="true"></i></span>
                                    </div>
                                    <input type="text" class="form-control" name="check_otp_code" value="" title="" required="" placeholder="Your OTP Code here">
                                </div>
                            </div>
                        </div>
                    </div>

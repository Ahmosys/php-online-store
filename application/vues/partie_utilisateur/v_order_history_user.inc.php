        ...
        <div class="col-lg-9 col-md-9 col-sm-6 mb-3">
            <div class="card mb-5">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php
                        if (VariablesGlobales::$theOrderUser == null) {
                            ?> 
                            ...
                            <div class="table-responsive m-5">
                                <table class="table table-striped table-bordered">
                                    <caption>History of your orders</caption>
                                    <thead>
                                        <tr>         
                                    ...
                                    <tbody>
                                        <?php
                                        foreach (VariablesGlobales::$theOrderUser as $theOccurrence) {
                                            ?>
                                            <tr>
                                                <?php
                                                $i = 0;
                                                foreach ($theOccurrence as $theAttribute) {
                                                    ...
                                                    if ($i == 4) {
                                                        ?>
                                                        <td class="text-right"><a href="index.php?controller=Utilisateur&action=showOrderContent&idOrder=<?= $theOccurrence->idCommande ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a></td>
                                                                <?php
                                                            }
                                                            ?>    
                                                            <?php
